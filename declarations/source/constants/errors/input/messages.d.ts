export const configPathSupposedToBeString: "`configPath` is supposed to be a string.";
export const configPathSupposedToBeDotJs: "`configPath` is supposed to be strictly JavaScript (`.js` only).";
export const noConfigFileFound: "No config file found for Comment Variables.";
export const configModuleCouldntResolve: "Config module could not get resolved. (Most probably due to fatal syntax.)";
