...
import { librariesMustKey, librariesMustSubKey, librariesRecordMustBeRecords, librariesShouldBeRecord, librariesValuesCannotBeEmptyStrings, librariesValuesMustBeStrings } from "../source/constants/errors/config/messages.mjs";
...
const ConfigLibrariesSchema = z.record(z.string(), z.record(z.string(), z.string({ error: librariesValuesMustBeStrings }).nonempty({ error: librariesValuesCannotBeEmptyStrings }), { error: librariesRecordMustBeRecords }).refine((record) => {
