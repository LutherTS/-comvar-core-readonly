...
const CONFIG_EMPTY = "CONFIG_EMPTY";
...
//#endregion
export { CONFIG_EMPTY, LIBRARIES_INVALID, LIBRARIES_NOT_KEY_CONFORM, LIBRARIES_NOT_RECORD, LIBRARIES_NOT_SUBKEY_CONFORM, LIBRARIES_RECORD_NOT_RECORDS, LIBRARIES_RECORD_RECORDS_VALUES_NOT_STRINGS };
