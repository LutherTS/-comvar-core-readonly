...
export type ResolveConfigReadonlyReturnType = ReturnType<
  typeof resolveConfigReadonly
>;

export type AllStaticErrorMessages_ErrorStatuses__Key =
  keyof typeof allStaticErrorMessages_errorStatuses;

export type ConfigPreStaticErrorMessage =
  (typeof configPreStaticErrorMessages)[number];

export type ConfigPreStaticErrorStatus =
  (typeof configPreStaticErrorStatuses)[number];

export type LibrariesStaticErrorMessage =
  (typeof librariesStaticErrorMessages)[number];

export type LibrariesStaticErrorStatus =
...
export type FlattenedConfigDataKeyGlobalRegex =
  typeof flattenedConfigDataKeyGlobalRegex;

export type FlattenedConfigDataPlaceholderLocalRegex =
  typeof flattenedConfigDataPlaceholderLocalRegex;

export type FlattenedConfigDataPlaceholderGlobalRegex =
  typeof flattenedConfigDataPlaceholderGlobalRegex;
