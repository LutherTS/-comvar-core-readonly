...
export const enData = Object.freeze({
          ...
          config: Object.freeze({
            messages: Object.freeze({
              ...
              librariesMustNotBeEmpty:
                "$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#_THECONFIG `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#VARIABLES#LIBRARIES` key's record must not be empty." /* variations: $COMMENT#TSDOC#SRC#CONSTS#ERRORS#CONFIG#MESSAGES#LIBRARIESMUSTNOTBEEMPTY / core: $COMMENT#EN#TSDOC#SRC#CONSTS#ERRORS#CONFIG#MESSAGES#LIBRARIESMUSTNOTBEEMPTY */,
              librariesMustSubKey:
              ...
              librariesRecordsMustNotBeEmpty:
                "$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#_THECONFIG `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#VARIABLES#LIBRARIES` key's record's records must not be empty." /* variations: $COMMENT#TSDOC#SRC#CONSTS#ERRORS#CONFIG#MESSAGES#LIBRARIESRECORDSMUSTNOTBEEMPTY / core: $COMMENT#EN#TSDOC#SRC#CONSTS#ERRORS#CONFIG#MESSAGES#LIBRARIESRECORDSMUSTNOTBEEMPTY */,
              librariesMustKey:
            ...
            statuses: Object.freeze({
              ...
              LIBRARIES_EMPTY:
                '"$COMMENT#EN#TSDOC#SRC#CONSTS#ERRORS#CONFIG#MESSAGES#LIBRARIESMUSTNOTBEEMPTY"' /* variations: $COMMENT#TSDOC#SRC#CONSTS#ERRORS#CONFIG#STATUSES#LIBRARIES_EMPTY / core: $COMMENT#EN#TSDOC#SRC#CONSTS#ERRORS#CONFIG#STATUSES#LIBRARIES_EMPTY */,
              ...
              LIBRARIES_RECORDS_EMPTY:
                '"$COMMENT#EN#TSDOC#SRC#CONSTS#ERRORS#CONFIG#MESSAGES#LIBRARIESRECORDSMUSTNOTBEEMPTY"' /* variations: $COMMENT#TSDOC#SRC#CONSTS#ERRORS#CONFIG#STATUSES#LIBRARIES_RECORDS_EMPTY / core: $COMMENT#EN#TSDOC#SRC#CONSTS#ERRORS#CONFIG#STATUSES#LIBRARIES_RECORDS_EMPTY */,
  ...
  composedVariablesExclusives: Object.freeze({
    variables: Object.freeze({
      ...
      subkeySeparator:
        "subkeySeparator" /* variations: $COMMENT#COMPOSEDVARIABLESEXCLUSIVES#VARIABLES#SUBKEYSEPARATOR / core: $COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#VARIABLES#SUBKEYSEPARATOR */,
      defaultConfigFileName:
