import { librariesCouldntZod, librariesMustKey, librariesMustSubKey, librariesRecordMustBeRecords, librariesShouldBeRecord, librariesValuesCannotBeEmptyStrings, librariesValuesMustBeStrings } from "./messages.mjs";
import { LIBRARIES_INVALID, LIBRARIES_NOT_KEY_CONFORM, LIBRARIES_NOT_RECORD, LIBRARIES_NOT_SUBKEY_CONFORM, LIBRARIES_RECORD_NOT_RECORDS, LIBRARIES_RECORD_RECORDS_VALUES_EMPTY_STRINGS, LIBRARIES_RECORD_RECORDS_VALUES_NOT_STRINGS } from "./statuses.mjs";
